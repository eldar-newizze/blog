                    ...
                    @csrf
						<div class="form-row">
								...
								<div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" name="sname" id="validationDefault02" placeholder="" required="">
								</div>
							</div>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="validationLogin">Login</label>
                                    <input type="text" name="login" class="form-control" id="validationDefault04">
                                </div>
                            </div>
							<div class="form-row">
